...
//const passwordHmacSecretSaltBase64       = process.env.secretSalt64_base64 /* Stored in Zeit secret nodejs-name-pass-auth___secretsalt64_base64 ==> process.env.secretSalt64_base64 env var. */
//const passwordHmacSecretString           = process.env.secretString_utf8   /* Stored in Zeit secret nodejs-name-pass-auth___secretstring_utf8 ==> process.env.secretString_utf8 env var. */
//const passwordHmacKeyBytesSize           = 64
//const passwordHmacScryptSecretKeySource  = crypto.scryptSync(passwordHmacSecretString, Buffer.from(passwordHmacSecretSaltBase64,'base64'), passwordHmacKeyBytesSize, {cost:16384,blockSize:8,parallelization:1,maxmem:(32*1024*1024)})
//const passwordHmacRandomSecretKeySource  = process.env.secretKeySource64_base64 /* Stored in Zeit secret nodejs-name-pass-auth___secretkeysource64_base64 ==> process.env.secretKeySource64_base64 env var. */
//const passwordHmacSecretKeySource        = passwordHmacScryptSecretKeySource
...
export {hashes as default, hashGeneral, hashPbkdf2, hashScrypt, hashBcrypt, hashArgon2, hashXXHash64, hashXXHash128, hashPw, hashPwVerify, pbkdf2Pw, pbkdf2PwVerify, scryptPw, scryptPwVerify, bcryptPw, bcryptPwVerify, argon2Pw, argon2PwVerify, xxHash64Pw, xxHash64PwVerify, xxHash128Pw, xxHash128PwVerify}
