...
const constructNowJSON_Template = (projName,domainAlias,buildDir) => {
  ...
  return "{\n"+
    ...
    "  },\n" +
    "  \"env\": {\n" +
    "    \"secretSalt64_base64\":      \"@nodejs-name-pass-auth___secretsalt64_base64\",\n"      +
    "    \"secretKeySource64_base64\": \"@nodejs-name-pass-auth___secretkeysource64_base64\",\n" +
    "    \"secretString_utf8\":        \"@nodejs-name-pass-auth___secretstring_utf8\"\n"         +
    "  },\n" +
    "  \"builds\": [\n" +
    ...
    "  ],\n" +
    "  \"routes\": [\n" +
    "    { \"src\":\"^/images/(.*).ico\",        \"dest\":\"/static/images/$1.ico\",  \"headers\":{\"cache-control\":\"s-maxage=86400\"} },\n" +
    "    { \"src\":\"^/images/(.*).png\",        \"dest\":\"/static/images/$1.png\",  \"headers\":{\"cache-control\":\"s-maxage=86400\"} },\n" +
    "    { \"src\":\"^/images/(.*).svg\",        \"dest\":\"/static/images/$1.svg\",  \"headers\":{\"cache-control\":\"s-maxage=86400\"} },\n" +
    "    { \"src\":\"^/fonts/(.*).woff2\",       \"dest\":\"/static/fonts/$1.woff2\", \"headers\":{\"cache-control\":\"s-maxage=86400\"} },\n" +
    "    { \"src\":\"^/css/(.*).css\",           \"dest\":\"/static/css/$1.css\",     \"headers\":{\"cache-control\":\"s-maxage=86400\"} },\n" +
    "    { \"src\":\"^/(.*).ico\",               \"dest\":\"/static/images/$1.ico\",  \"headers\":{\"cache-control\":\"s-maxage=86400\"} },\n" +
    "    { \"src\":\"^/404.html?\",              \"dest\":\"/static/404.html\",       \"headers\":{\"cache-control\":\"s-maxage=86400\"} },\n" +
    "    { \"src\":\"^/(.*).html?\",             \"dest\":\"/static/index.html\",     \"headers\":{\"cache-control\":\"s-maxage=86400\"} },\n" +
    "    { \"src\":\"^/auth\",                   \"dest\":\"/index.js\",              \"headers\":{\"cache-control\":\"s-maxage=600\"}   },\n" +
    "    { \"src\":\"^/auth/(.*).js\",           \"dest\":\"/$1.js\",                 \"headers\":{\"cache-control\":\"s-maxage=600\"}   },\n" +
    "    { \"src\":\"^/auth/(.*)\",              \"dest\":\"/index.js\",              \"headers\":{\"cache-control\":\"s-maxage=600\"}   },\n" +
    "    { \"src\":\"^/(.*)\",                   \"dest\":\"/static/index.html\",     \"headers\":{\"cache-control\":\"s-maxage=600\"}   }\n"  +
    "  ]\n" +
    "}"
}
