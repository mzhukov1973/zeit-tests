...
const constructNowJSON_Template = (projName,domainAlias,buildDir) => {
  ...
  return "{\n"+
    ...
    "  },\n" +
    "  \"env\": {\n" +
    "    \"logzioAccountName\":           \"@ot-logs___logzio_account-name\",\n"            +
    "    \"logzioAccountType\":           \"@ot-logs___logzio_account-type\",\n"            +
    "    \"logzioAccountToken\":          \"@ot-logs___logzio_account-token\",\n"           +
    "    \"timberioCredentialsSourceId\": \"@ot-logs___timberio_credentials-source-id\",\n" +
    "    \"timberioCredentialsAPIKey\":   \"@ot-logs___timberio_credentials-api-key\"\n"    +
    "  },\n" +
    "  \"builds\": [\n" +
    ...
    "    { \"src\":\"^/log\",                    \"dest\":\"/index.js\",              \"headers\":{\"cache-control\":\"s-maxage=600\"}   },\n" +
    "    { \"src\":\"^/log/(.*).js\",            \"dest\":\"/$1.js\",                 \"headers\":{\"cache-control\":\"s-maxage=600\"}   },\n" +
    "    { \"src\":\"^/log/(.*)\",               \"dest\":\"/index.js\",              \"headers\":{\"cache-control\":\"s-maxage=600\"}   },\n" +
